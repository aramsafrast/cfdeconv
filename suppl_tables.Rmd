...
load("./temp_files/age_stat.RData")
...
table1 <- rbind(stat.test, stat.test1) %>% dplyr::inner_join(., rbind(stat.test_effect, stat.test_effect1)) %>% dplyr::rename(variable1 = "gender")
table2 <- rbind(stat.test2, stat.test3) %>% dplyr::inner_join(., rbind(stat.test_effect2, stat.test_effect3)) %>% dplyr::rename(variable1 = "cond")
table_join <- rbind(table1, table2) 
table3 <- stat.test4 %>% dplyr::inner_join(., stat.test_effect4) %>% dplyr::rename(variable1 = "gender") %>% dplyr::rename(variable2 = "cond") 
