...
o5 <- ggarrange(o1, o2, o3, o4, common.legend = TRUE, labels = "AUTO", hjust = -2, font.label = list(size = 20, family = "Helvetica")) + plot_annotation(title = "Importance of cell types in random forest models per dataset", theme = theme(plot.title = element_text(size = 20, family = "Helvetica", face = "bold", hjust = 0.5)))
...
k3 <- ggarrange(k1, k2, labels = "AUTO", hjust = -2, font.label = list(size = 20, family = "Helvetica")) + plot_annotation(title = "Cell type proportion differences between plasma and EV samples", theme = theme(plot.title = element_text(size = 20, family = "Helvetica", face = "bold", hjust = 0.5)))
# p5
